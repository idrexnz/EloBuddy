...
namespace Thresh
{
    public static class MenuManager
    {
        ...
        public static void Init(EventArgs args)
        {
            ...
            SubMenu["Prediction"].Add("QCombo", new Slider("Combo HitChancePercent", 91));
            SubMenu["Prediction"].Add("QHarass", new Slider("Harass HitChancePercent", 95));
            SubMenu["Prediction"].AddGroupLabel("E Settings");
            SubMenu["Prediction"].Add("ECombo", new Slider("Combo HitChancePercent", 91));
